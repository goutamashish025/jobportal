...
<div id="wpbaw_review_tabs" class="wpbaw-vtab-cnt wpbaw_review_tabs wpbaw-clearfix">
	<!-- Start - Testimonial Section -->
	<div class="wpbaw-sf-testimonial-wrap">
		<div class="wpbaw-sf-center wpbaw-sf-features-ttl">
			<h1 class="wpbaw-sf-heading">Looking for a Reason to Use <span class="wpbaw-sf-blue">Essential Plugin </span>with News?</h1>
			<div class="wpbaw-sf-cont wpbaw-center" style="margin:10px 0;"> Here are 40+...</div>
		</div>
		<div class="wpbaw-testimonial-section-inr">
			...
			<a href="https://wordpress.org/support/plugin/wp-blog-and-widgets/reviews/?filter=5" target="_blank" class="wpbaw-sf-btn"><span class="dashicons dashicons-star-filled"></span> View All Reviews</a>
		</div>
	</div>
