	...
	<div class="wpbaw-deal-offer-wrap">
		<div class="wpbaw-deal-offer"> 
			<div class="wpbaw-inn-deal-offer">
				...
				<h4 class="wpbaw-inn-deal-sub-hedding"><span style="color:red;">Extra Bonus: </span>Users will get <span>15% off</span> on the regular price using this coupon code.</h4>
			</div>
			<div class="wpbaw-inn-deal-offer-btn">
				<div class="wpbaw-inn-deal-code"><span>EPS15</span></div>
				<a href="<?php echo WPBAW_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wpbaw-sf-btn wpbaw-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Get Essential Bundle Now</a>
			</div>
		</div>
	</div>
</div>