		...
		<div id="post-body" class="metabox-holder">
			<div id="post-body-content">
				...
				<div style="text-align: center; background: #DCDCDC; margin: 30px 0; padding: 10px 30px 30px 30px;">
					...
					<a href="<?php echo WPBAW_PLUGIN_LINK_UPGRADE; ?>" target="_blank" class="wpbaw-sf-btn wpbaw-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
				</div>
				...
				<h2 style="font-size: 24px; text-align: center; color: #6c63ff;">Bundle Deal Details</h2>
					...
					<div style="text-align: center;">
						...
						<a href="<?php echo WPBAW_PLUGIN_LINK_UPGRADE; ?>" target="_blank" class="wpbaw-sf-btn wpbaw-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Bundle Deal</a>
					</div>
			</div>
		</div>
	</div>
