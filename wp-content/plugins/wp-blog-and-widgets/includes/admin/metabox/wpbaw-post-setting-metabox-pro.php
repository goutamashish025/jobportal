...
<div class="pro-notice"><?php echo sprintf( __( 'Utilize these %sPremium Features%s to get best of this plugin.', 'wp-blog-and-widgets'), '<a href="'.WPBAW_PLUGIN_LINK_UNLOCK.'" target="_blank">', '</a>' ); ?></div>
