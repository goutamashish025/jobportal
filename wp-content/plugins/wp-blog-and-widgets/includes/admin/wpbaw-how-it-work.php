			...
			<div id="post-body-content">
				...
				<div class="meta-box-sortables">
					<div class="postbox">
						<div class="postbox-header">
							<h2 class="hndle">
								<span><?php esc_html_e( 'Need Support & Solutions?', 'wp-blog-and-widgets' ); ?></span>
							</h2>
						</div>
						<div class="inside wpos-clearfix">
							<div class="wpos-col">
								<div class="wpos-box">
									<h5 style="font-size: 18px;line-height: 30px;margin: 10px 0px; background:#0055fb;"><?php esc_html_e('Blog and Widget Premium Features','wp-blog-and-widgets'); ?></h5>
									<h4><?php esc_html_e('Single Plugin', 'wp-blog-and-widgets'); ?></h4>
									<ul class="wpos-list">
										...
										<li><a href="<?php echo WPBAW_PLUGIN_LINK_UPGRADE; ?>" target="_blank"><?php esc_html_e('View More All Features', 'wp-blog-and-widgets'); ?></a></li>
									</ul>
									<div style="text-align:center;">
										<a class="button button-primary button-blue" href="<?php echo WPBAW_PLUGIN_LINK_UPGRADE; ?>" target="_blank"><?php esc_html_e( 'Grab Now', 'wp-blog-and-widgets' ); ?></a>
									</div>
								</div>
							</div>
							<div class="wpos-col">
								<div class="wpos-box">
									<h5 style="font-size: 18px;line-height: 30px;margin: 10px 0px; background:#ff5d52;"><?php esc_html_e('Essential Bundle With Blog and Widget', 'wp-blog-and-widgets'); ?></h5>
									<h4><?php esc_html_e('Bundle Deal', 'wp-blog-and-widgets'); ?></h4>
									<ul style="margin: 0;list-style: none;font-size: 16px;">
										<li style="margin-bottom:8px;">
											<span style="display:inline-block;vertical-align: middle;"><img src="<?php echo WPBAW_URL; ?>assets/images/utility-50.png" width="24"></span> <span style="display:inline-block;vertical-align: middle;"><?php esc_html_e('39 Utility Plugins', 'wp-blog-and-widgets'); ?></span>
										</li>
										<li style="margin-bottom:8px;">
											<span style="display:inline-block;vertical-align: middle;"><img src="<?php echo WPBAW_URL; ?>assets/images/SlidersPack-50.png" width="24"></span> <span style="display:inline-block;vertical-align: middle;"><?php esc_html_e('10 SlidersPack', 'wp-blog-and-widgets'); ?></span>
										</li>
										<li style="margin-bottom:8px;">
											<span style="display:inline-block;vertical-align: middle;"><img src="<?php echo WPBAW_URL; ?>assets/images/popup-anything-icon.png" width="24"></span> <span style="display:inline-block;vertical-align: middle;"><?php esc_html_e('Popup Anything A Marketing Popup', 'wp-blog-and-widgets'); ?></span>
										</li>
										<li>
											<span style="display:inline-block;vertical-align: middle;"><img src="<?php echo WPBAW_URL; ?>assets/images/security-icon.png" width="24"></span> <span style="display:inline-block;vertical-align: middle;"><?php esc_html_e('Essential Security', 'wp-blog-and-widgets'); ?></span>
										</li>
									</ul>
									<div style="text-align:center;">
										<a class="button button-primary button-orange" href="<?php echo WPBAW_PLUGIN_BUNDLE_LINK; ?>" target="_blank"><?php esc_html_e('Grab Now', 'wp-blog-and-widgets'); ?></a>
									</div>
								</div>
							</div>
				...
				<div class="meta-box-sortables">
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							...
							<a class="button button-primary wpos-button-full button-orange" href="<?php echo WPBAW_PLUGIN_LINK_UPGRADE; ?>" target="_blank"><?php esc_html_e('Grab Blog and Widget Now', 'wp-blog-and-widgets'); ?></a>
						</div><!-- .inside -->
					</div><!-- #general -->
				</div><!-- .meta-box-sortables -->
